											...
											<div>${errormsg}</div>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" name="loginName" value="<%=ObjectUtils.toString(new CookieHandle().getCookieValue(request, "loginName"))  %>" placeholder="Username" class="form-control" id="loginName">
														<i class="ace-icon fa fa-user"></i> </span>
												</label>

												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" name="pwd" value="" placeholder="Password" class="form-control" id="pwd"> 
												...
												<div class="clearfix">
													...
													<input type="hidden" name="redirectURL" value=<%=request.getParameter("redirectURL")==null?"":request.getParameter("redirectURL")%>>
