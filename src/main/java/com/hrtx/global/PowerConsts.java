...
public enum PowerConsts {
	...
	SYSMOUDULE(90300,"配置管理",90000,0,"system/system-query",2,1),//SYS管理
	SYSMOUDULE_COMMON_QUEYR(90301,"查询",90300,1,"",3,1),//SYS查询
	SYSMOUDULE_COMMON_EDIT(90302,"修改",90300,1,"",3,2),//SYS修改
	SYSMOUDULE_COMMON_AUDIT(90303,"审核",90300,1,"",3,3),//SYS审核
	SYSMOUDULE_COMMON_ADD(90304,"添加",90300,1,"",3,4),//SYS添加
	;
