...
//	SYSTEMMOUULE_USERLIST_UPPWD(90205,"修改密码",90200,1,"",3,6),
	...
	CHANNELMOUDULE_COMMON_QUEYR(70801,"查询",70800,1,"",3,1),//渠道和价格规则查询
	CHANNELMOUDULE_COMMON_EDIT(70802,"修改",70800,1,"",3,2),//修改
	CHANNELMOUDULE_COMMON_DELETE(70803,"删除",70800,1,"",3,3),//删除
	CHANNELMOUDULE_COMMON_ADD(70804,"添加",70800,1,"",3,4),//添加

	NUMPRICEMOUDULE(70900,"号码价格管理",70000,0,"numprice/numprice-query",2,1),
...
/*	DELIVERYADDRESSMOUDULE(90600,"收货地址管理",90000,0,"deliveryAddress/deliveryAddress-query",2,1),//收货地址管理
	...
	EPSALEMOUDULE(90700,"竞拍活动管理",90000,0,"epSale/epSale-query",2,1),//竞拍活动管理
	EPSALEMOUDULE_COMMON_ADD(90701,"添加",90700,1,"",3,1),//竞拍活动添加
