...
public enum PowerConsts {
	...
	GOODSMOUDULE_COMMON_QUEYR(70301,"查询",70200,1,"",3,1),//商品查询
	GOODSMOUDULE_COMMON_EDIT(70302,"修改",70200,1,"",3,2),//商品修改
	GOODSMOUDULE_COMMON_DELETE(73203,"删除",70200,1,"",3,3),//商品删除
