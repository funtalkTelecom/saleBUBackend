...
public class Auction extends BasePojo implements java.io.Serializable {
    ...
    public Auction(Integer id, Integer skuId, Integer numId, String num, String gName,Integer gId, double price, int status,
                   Date addDate,Date confirmDate, Integer consumerId,
